...
import CursiveTitle from '../../components/legacy/CursiveTitle';
  ...
  useGSAP(() => {
    ...
    mm.add(
      ...
      context => {
        ...
        gsap.from('.tecnologiasAnimation', {
          opacity: 0,
          scale: 1.04,
    ...
    >
      ...
      >
        <div className={cn('relative flex flex-col max-lg:gap-4', { 'bg-green-box': showBoxes })}>
          <h2 className='text-[52.67px] lg:text-[97.66px] text-center tecnologiasAnimation'>Tecnologías.</h2>
          <CursiveTitle className='absolute left-[50%] -translate-x-[50%] top-12 lg:top-18 -z-10 tecnologiasAnimation'>Tecnologias</CursiveTitle>
          <p className='lg:text-xl font-light text-center tecnologiasAnimation'>
