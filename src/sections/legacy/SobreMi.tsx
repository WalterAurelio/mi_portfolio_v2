  ...
  return (
    ...
    >
      <div className={clsx('flex flex-col gap-10 max-w-265.5 relative', { 'bg-yellow-box': showBoxes })}>
        <h2 className='text-[61.04px] lg:text-[97.66px] sobreMiAnimation'>Sobre mí.</h2>
        <CursiveTitle className='absolute left-27 top-14 lg:top-18 -z-10 sobreMiAnimation'>Sobre mi</CursiveTitle>
        <p className='lg:text-xl leading-8 font-light sobreMiAnimation'>
