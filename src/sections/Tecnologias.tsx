...
function Tecnologías() {
  ...
  return (
    <section id='tecnologias-section' className='bg-red-200 py-10 flex flex-col justify-between'>
      <div className='flex flex-col justify-center bg-amber-200 max-w-[534px] relative m-auto tecnologias-descripcion'>
