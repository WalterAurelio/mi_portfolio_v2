...
function Footer({ showBoxes }: ShowBoxes) {
  return (
    <footer className={cn('p-10 -ml-10 w-dvw bg-main-black flex justify-between border-t border-transparent-white-30', { 'bg-red-box': showBoxes})}>
      <div className='flex flex-col gap-1 text-main-white w-fit'>
      ...
      <div className='flex gap-10'>
        <div className='text-transparent-white-60 flex flex-col w-21.5'>
