...
const variants = cva(['flex w-40 h-15 justify-center items-center text-lg font-medium text-main-white cursor-pointer leading-normal hover:scale-110 transition-all'], {
  variants: {
    variant: {
