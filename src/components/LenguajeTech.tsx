...
function LenguajeTech({ className, description = 'Lorem ipsum', icon, ...props }: LenguajeTechProps) {
  return (
    <div
      className={cn(
        'w-[137px] lg:w-45 aspect-[1/1.3] flex flex-col items-center border border-transparent-grey-30 backdrop-blur-sm rounded-[40px] lg:rounded-[52px] bg-transparent-white-20 relative overflow-clip',
        className
      )}
      {...props}
    >
